                ...
                <!-- Title of Tile and Minimize button -->
                  ...
                  <!-- Content of Tile -->
                    <div class="x_content">
                        ...
                        <a href="{{url('/admin/stockview/table') }}" type="button" class="btn btn-success">View Stock</a>
                        <a href="{{url('/admin/stockview/edit') }}" type="button" class= "btn btn-rectangle btn-warning">Edit Stock</a>
                        <a href="{{url('/admin/stockview/table') }}" class="btn btn-rectangle btn-danger">Delete Stock</button>
